...
INSERT INTO `reports`
VALUES (NULL, SUBSTR(MD5(RAND()), 1, 20), 5, 5, "Huge flash flood in affecting the town. This is affecting travel and causing damage to homes", 3, 0.5, "52.047212, -3.958855", "2021-12-03  08:13:00", "SA19 8UW", "Carmarthenshire", 0);
INSERT INTO `reports`
VALUES (NULL, SUBSTR(MD5(RAND()), 1, 20), 6, 3, "Huge storm and waves last night. Some houses nearest to the sea have been damaged", 0.25, 0.3456, "52.251609, -4.229779", "2021-12-02  06:15:00", "SA46 0LN", "Ceredigion", 0);
INSERT INTO `reports`
...
INSERT INTO `reports`
VALUES (NULL, SUBSTR(MD5(RAND()), 1, 20), 12, 4, "Plastic waste left behind after flooding", 6, 0, "53.131942, -4.265442", "2021-11-29  19:50:00", "LL55 2DJ", "Gwynedd", -1);
INSERT INTO `reports`
VALUES (NULL, SUBSTR(MD5(RAND()), 1, 20), 13, 5, "Very bad flooding from storm", 2, 0.25, "52.218966, -3.931732", "2021-10-13  13:00:00", "SY25 6JX", "Ceredigion", 0);
INSERT INTO `reports`
VALUES (NULL, SUBSTR(MD5(RAND()), 1, 20), 14, 4, "Debris washed up from river", 6, 0.05, "52.14908, -3.413315", "2021-09-09  14:00:00", "LD2 3NL", "Powys", 0);
INSERT INTO `reports`
VALUES (NULL, SUBSTR(MD5(RAND()), 1, 20), 15, 1, "Sewer flooding - drains in street are overflowed", 1, 0.1, "52.717163, -3.696899", "2021-11-11  19:00:00", "SY20 9LL", "Gwynedd", 0);
INSERT INTO `reports`
VALUES (NULL, SUBSTR(MD5(RAND()), 1, 20), 16, 3, "Coastal flooding has reached some holiday homes on the beach", 3, 0.5, "51.650061, -4.761457", "2021-06-16  06:00:00", "SA70 7SB", "Pembrokeshire", 0);
-- end of reference 
